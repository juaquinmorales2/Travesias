...
import fondo from "../sections/image.png";
      ...
      >
        ...
        <div className="relative p-8 flex flex-col items-center gap-6">
          ...
          <button
            ...
            className="absolute top-4 right-4 text-white hover:text-gray-300 transition text-3xl font-bold"
          >
            ×
          </button>
          ...
          <a
            href="https://whatsapp.com/channel/0029VbAsEXEEwEjxD0uBx82K"
            target="_blank"
          ...
          >
            {/* Icono WhatsApp SVG más grande y nitido */}
