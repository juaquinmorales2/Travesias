      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto w-full">
        ...
        <div className="flex space-x-6 mb-6 text-center items-center justify-center">
          ...
          <a href="https://www.linkedin.com/in/navegandotv/" target="_blank" rel="noopener noreferrer" className="group">
            <svg className="w-6 h-6 group-hover:text-teal-200 transition-colors" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.tiktok.com/@navegandotv" target="_blank" rel="noopener noreferrer" className="group">
            <svg className="w-6 h-6 group-hover:text-teal-200 transition-colors" fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
